...
void saveMar31ThorughApr7GraphsToDisk()
{
  ...
  ConsentrationGraph conspumtionGraph = CgmsDataImport::importSpreadsheet( "../data/march30_apr1st_diabetesLog.csv",
                                              ...
                                              time_from_string(startDate),
                                              time_from_string(endDate) );
  ConsentrationGraph insulinGraph = CgmsDataImport::bolusGraphToInsulinGraph( bolusGraph, ProgramOptions::kPersonsWeight );
...
void testKineticModels()
{
  ...
  ConsentrationGraph insConcen = novologConsentrationGraph( kGenericT0, 5.0/ProgramOptions::kPersonsWeight, timeStep );
