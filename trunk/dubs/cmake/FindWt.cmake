...
IF( Wt_INCLUDE_DIR )
        ...
        IF( Wt_LIBRARY AND Wt_EXT_LIBRARY AND Wt_FCGI_LIBRARY AND NOT Wt_HTTP_LIBRARY )
                SET( Wt_FOUND TRUE )
		SET( Wt_FIND_REQUIRED_Release TRUE )
                SET( Wt_LIBRARIES ${Wt_LIBRARY} ${Wt_EXT_LIBRARY} ${Wt_FCGI_LIBRARY} )
        ENDIF( Wt_LIBRARY AND Wt_EXT_LIBRARY AND Wt_FCGI_LIBRARY AND NOT Wt_HTTP_LIBRARY )
